...
const BottomNavbar = ({ activePath }: BottomNavbarProps) => {
  ...
  return (
    <nav className="fixed bottom-0 left-0 w-full py-2 flex justify-around items-center rounded-t-3xl backdrop-blur-sm z-40 bg-white bg-opacity-90 shadow-lg shadow-gray-200/50 dark:bg-merchant dark:bg-opacity-90 dark:shadow-black/50">
      <Link href="/" passHref>
